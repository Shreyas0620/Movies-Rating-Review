        ...
        <div className='xl:bg-main bg-dry flex-colo xl:bg-opacity-90 xl:absolute top-0 left-0 right-0 bottom-0'>
          <div className='container px-3 mx-auto 2xl:px-32 xl:grid grid-cols-3 flex-colo py-10 lg:py-20 gap-8'>
            <div className='xl:col-span-1 w-full xl:order-none order-last h-header bg-dry border border-gray-800 rounded-lg overflow-hidden'>
              <img
                src={movie?.titleImage || "/images/movies/default.jpg"}
                alt={movie?.name}
            ...
            <div className='col-span-2 md:grid grid-cols-5 gap-4 items-center'>
              <div className='col-span-3 flex flex-col gap-10'>
                ...
                <div className='grid sm:grid-cols-5 grid-cols-3 gap-4 p-2 bg-main border border-gray-800 rounded-lg'>
              ...
              <div className='col-span-2 md:mt-0 mt-2 flex justify-end'>
                <button className='md:w-1/6 w-full relative flex-colo bg-subMain hover:bg-transparent border-2 border-subMain transitions md:h-64 h-20 rounded font-medium'>
                  <div className='flex flex-col md:flex-row items-center gap-2 md:gap-4 text-md uppercase tracking-widest md:rotate-90'>
                    <span>Download</span>
