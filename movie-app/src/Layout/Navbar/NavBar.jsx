    ...
    <>
      <div className='bg-main shadow-md sticky top-0 z-20'>
        <div className='container mx-auto py-6 px-2 lg:grid gap-10 grid-cols-7 justify-between items-center'>
          ...
          {/* Menus Here */}
          <div className='col-span-3 font-medium text-sm hidden xl:gap-14 2xl:gap-20 justify-between lg:flex xl:justify-center items-center'>
            ...
            >
              {userInfo ? (
                <img
                  src={userInfo?.image ? userInfo.image : '/images/peterImage.jpg'}
